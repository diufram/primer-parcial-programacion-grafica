...
public class Constantes {
    ...
    // Configuracion visual del tercer jugador.
    ...
    // Posicion horizontal inicial del tercer jugador.
    ...
    public static final String SHADER_FRAGMENT_SOURCE = "#version 330 core\n" +
            "uniform vec4 uColor;\n" +
            "out vec4 fragColor;\n" +
            "void main() {\n" +
            "    fragColor = uColor;\n" +
    ...
    public static final String SHADER_VERTEX_TEXTURA_SOURCE = "#version 330 core\n" +
            "layout (location = 0) in vec2 aPos;\n" +
    ...
    public static final String SHADER_FRAGMENT_TEXTURA_SOURCE = "#version 330 core\n" +
            "in vec2 vTexCoord;\n" +
